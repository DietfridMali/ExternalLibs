...
void zbar_rs_encode(const rs_gf256 *_gf, unsigned char *_data, int _ndata,
...
int main(void)
{
	...
	zbar_rs_encode(&gf, QR_M0, data, ndata, genpoly, npar);
...
int main(void)
{
	...
	if (nerrors >= 0) {
		...
		data2[i] = data[i];
	    rs_compute_genpoly(&gf, QR_M0, genpoly, npar);
	    zbar_rs_encode(&gf, QR_M0, data2, ndata, genpoly, npar);
